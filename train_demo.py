...
def main():
    base_dir = ""
    full_images_dir = r'C:\Networks\mobileye\bochum'
    ...
    trained_model_path = go_train(base_dir, model_name, train_dataset, test_dataset, num_epochs=40)
